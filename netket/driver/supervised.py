...
class Supervised(AbstractVariationalDriver):
    ...
    def __init__(
        ...
        *,
        ...
        if variational_state.hilbert != target.hilbert:
            raise TypeError(
                dedent(
        ...
        super().__init__(variational_state, optimizer, minimized_quantity_name="Fidelity")
    ...
    def _forward_and_backward(self):
        ...
        self._loss_stats, self._loss_grad = self.state.fidelity_and_grad(self._target)
